...
// Font Awesome CSS is now loaded in index.html for better performance
      ...
      <div className="container">
        ...
        <nav>
          <ul className={isMenuOpen ? 'active' : ''}>
            <li><button onClick={() => handleNavClick('/')} className={`nav-link ${activePage === '/' || activePage === '/home' ? 'active' : ''}`}>Home</button></li>
...
const Layout = () => {
    ...
    return (
        <>
            ...
            {/* Font Awesome CSS loaded in index.html */}
            ...
            <main>
                <Routes>
                    {/* Home page route - also handle root path */}
